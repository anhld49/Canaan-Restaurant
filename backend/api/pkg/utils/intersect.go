...
// SimpleGeneric: Simple has complexity: O(n^2)
...
// HashGeneric: Hash has complexity: O(n * x) where x is a factor of hash function efficiency (between 1 and 2)
...
// Sorted: Deprecated: Use SortedGeneric instead. Complexity same as SortedGeneric.
...
// Hash: Deprecated: Use HashGeneric instead. Complexity same as HashGeneric.
